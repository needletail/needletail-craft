...
use needletail\needletail\assetbundles\needletailwidgetwidget\NeedletailWidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class NeedletailWidget extends Widget
{
    ...
    {
        return Craft::t('needletail', 'NeedletailWidget');
    }
    ...
    {
        return Craft::getAlias("@needletail/needletail/assetbundles/needletailwidgetwidget/dist/img/NeedletailWidget-icon.svg");
    }
    ...
    public function getBodyHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'needletail/_components/widgets/NeedletailWidget_body',
            [
